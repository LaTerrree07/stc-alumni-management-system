<x-app-layout>
    ...
    <div class="mx-auto max-w-4xl space-y-6">
        <div>
            <h1 class="text-2xl font-bold text-gray-900">Create Job Post</h1>
            <p class="mt-1 text-sm text-gray-600">
                Add a job opportunity for alumni.
            </p>
        </div>

        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <form method="POST" action="{{ route($routePrefix . '.job-posts.store') }}" class="space-y-6">
                @csrf
