...
<head>
    ...
    <title>Admin Login | STCTI Alumni Management System</title>
            ...
            <div class="relative flex h-full items-center px-16">
                <div class="max-w-xl text-white">
                    ...
                    <p class="mt-6 max-w-lg text-base leading-8 text-white/85">
                        Secure admin access for managing alumni profiles, events, donations,
                        announcements, opportunities, notifications, and system records.
                    </p>
                </div>
            </div>
        </div>
            ...
            <div class="w-full max-w-md">
                ...
                <div class="mb-8">
                    ...
                    <p class="mt-3 text-sm leading-6 text-gray-600">
                        Enter your admin email and password to access the administration panel.
                    </p>
                </div>
