<x-app-layout>
    ...
    <div class="mx-auto max-w-4xl space-y-6">
        ...
        <div class="rounded-xl border border-gray-200 bg-white p-6 shadow-sm">
            <form method="POST" action="{{ route($routePrefix . '.donations.update', $donation) }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')

                @include('donations._form', ['donation' => $donation])
