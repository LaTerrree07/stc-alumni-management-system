...
Route::middleware('guest')->group(function () {
    ...
    */
    ...
    |--------------------------------------------------------------------------
    | /login redirects to Alumni Login by default.
    | Admin must use /admin/login.
    | Alumni must use /alumni/login.
    */
    ...
    Route::get('alumni/login', [AuthenticatedSessionController::class, 'createAlumni'])
        ->name('alumni.login');

    Route::post('alumni/login', [AuthenticatedSessionController::class, 'storeAlumni'])
